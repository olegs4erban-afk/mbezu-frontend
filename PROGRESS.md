...
- `[blocked→Олег] Яндекс Бизнес` — форма https://yandex.ru/sprav/add: название «Mila Bezú — картины маслом», рубрика «Художественная мастерская» выбраны; остановился на необратимом вопросе «есть ли место, куда могут прийти клиенты» (адрес мастерской публиковать? или «только в интернете»). Дальше: телефон, сайт, подтверждение по звонку/СМС на номер организации.
