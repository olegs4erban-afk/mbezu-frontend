...
const ARTWORKS = [
  ...
  // ── НОВАЯ работа ST-08 ──
  {
    ...
    style: 'Городской реализм',
    framing: 'Без рамы, на подрамнике',
    price: 75000, status: 'available',            // ⚠ цена уточнить
    description:
  ...
  // ─── ТОНДО (новая серия) ───────────────────────────────────
  {
    ...
    price: 85000, status: 'available',            // ⚠ цена уточнить
    description:
  ...
  },
  {
    ...
    style: 'Современный реализм',
    framing: 'Круглый формат · без рамы',
    price: 130000, status: 'available',           // ⚠ цена уточнить
    description:
