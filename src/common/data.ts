...
const SERIES = [
  ...
  {
    id: 'streets',
    title: 'Улицы мира и других стран',
...
const ABOUT = {
  ...
  short: [
    ...
    'Серии «Улицы мира и других стран», «Тихая сила», монохромное направление и круглые тондо — ' +
  ...
  bio: [
    ...
    'Серия «Улицы мира и других стран» — городские пейзажи Греции, Португалии, Франции, Камбоджи, Вьетнама, ' +
